...
describe("<AccountModal />", () => {
    ...
    let essentialProps ={
        show: true,//={this.state.accountModalShow}
        onHide: false,//this.setState({accountModalShow : false})},
        user_id: 1 ,// = {this.props.userID}
        updateAccState: null,//= {this.getAccountDetails}
        setID: null,//= {this.props.setID}
        username: "props user", //{this.state.accountData.username}
        password: "props password" //{this.state.accountData.password}
    }
